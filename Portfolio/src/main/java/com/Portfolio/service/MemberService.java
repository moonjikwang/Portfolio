...
public class MemberService {
	...
	public String getAccessToken(String authorize_code) throws Exception {
		...
		try {
			...
			sb.append("&client_id=7226e94e9966b51700e15e1823408600"); // REST_API키 본인이 발급받은 key 넣어주기
			sb.append("&redirect_uri=https://tomcat.jikwang.net/Portfolio/oauth"); // REDIRECT_URI 본인이 설정한 주소 넣어주기
